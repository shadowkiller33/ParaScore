...
model2layers = {
    ...
    "bert-base-chinese": 8,
    "tuhailong/SimCSE-bert-base":9,
    "uer/sbert-base-chinese-nli":8,
    "uer/simcse-base-chinese":9,
    "DMetaSoul/sbert-chinese-general-v2":8,
    ...
    "hfl/chinese-roberta-wwm-ext":10,
    ...
    "princeton-nlp/unsup-simcse-bert-base-uncased": 9,  # 0.675911357700092
    "princeton-nlp/sup-simcse-bert-base-uncased": 9,  # 0.675911357700092
}
